...
import com.android.inputmethod.pinyinime.SoftKeyboard.KeyRow;
...
public class XmlKeyboardLoader {
	/**
	 * The tag used to define an xml-based soft keyboard template. xml标签
	 */
	 ...
	 * {@link #XMLTAG_SKB_TEMPLATE} element in the xml file. file. xml标签
	 */
	 ...
	 * {@link #XMLTAG_SKB_TEMPLATE} and {@link #XMLTAG_KEYBOARD}. xml标签中的属性
	 */
	 ...
	 * calculate its own position. xml标签中的属性
	 */
	 ...
	 * soft keyboard. xml标签中的属性
	 */
	private static final String XMLATTR_ROW_ID = "row_id";

	/** The tag used to indicate the keyboard element in the xml file. xml标签 */
	private static final String XMLTAG_KEYBOARD = "keyboard";

	/** The tag used to indicate the row element in the xml file. xml标签 */
	private static final String XMLTAG_ROW = "row";

	/** The tag used to indicate key-array element in the xml file. xml标签 */
	 ...
	 * defined in a soft keyboard, id is not required. xml标签
	 */
	private static final String XMLTAG_KEY = "key";

	/** The tag used to indicate a key's toggle element in the xml file. xml标签 */
	 ...
	 * {@link #XMLTAG_TOGGLE_STATE} xml标签中的属性
	 */
	private static final String XMLATTR_TOGGLE_STATE_ID = "state_id";

	/** Attribute tag of key template for the soft keyboard. xml标签中的属性 */
	 ...
	 * specifies the default value. xml标签中的属性
	 */
	 ...
	 * valid key type id by adding 1. 无效key type id。最后的key type id。
	 */
	 ...
	 * the the current event. 处理当前事件的时候，下一个事件是否已经到达。
	 */
	...
	/**
	 * 解析一个按键，其中调用getToggleStates（）解析ToggleState按键变换状态。
	 * 
	 * @param xrp
	 * @param attrKey
	 * @return
